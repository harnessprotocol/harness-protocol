      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 pb-16 pt-28 text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-fd-muted-foreground">
            Define your agent's complete context — plugins, MCP servers, environment,
            instructions, and permissions — in a single, portable{' '}
            <code className="rounded bg-fd-card px-1.5 py-0.5 text-sm font-mono text-fd-foreground">harness.yaml</code>.
          </p>
