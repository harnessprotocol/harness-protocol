...
The Schema layer defines how a `harness.yaml` is structured, validated, and applied. At a high level, the flow has three phases (for the complete 7-step pipeline, see [Application Semantics](../specification/application)):
