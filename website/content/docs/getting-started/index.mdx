...
- **The `harness.yaml` format** — a structured YAML document with top-level sections for metadata, plugins, MCP servers, environment declarations, instructions, permissions, and inheritance. See [Profile Schema](../specification/profile-schema) for the full specification.
