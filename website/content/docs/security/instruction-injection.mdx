...
<Callout type="warn" title="Security-critical">
  Instruction injection is the highest-severity threat in the Harness Protocol security model. Conforming implementations MUST enforce the source-labeling and trust-boundary rules in this document.
</Callout>
