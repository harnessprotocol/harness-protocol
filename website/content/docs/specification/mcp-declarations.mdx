---
title: MCP Declarations
description: MCP server transport types, variable substitution, and security requirements.
---

import { Tabs, Tab } from 'fumadocs-ui/components/tabs';

This document specifies how MCP (Model Context Protocol) servers are declared in `harness.yaml` under the `mcp-servers:` key. For the reference field table, see [Profile Schema: mcp-servers](./profile-schema#mcp-servers). This document provides expanded detail, security requirements, and practical examples.
