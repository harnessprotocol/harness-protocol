---
title: Fragments
description: "kind: fragment — partial harness documents for composition and reuse."
---
...
Fragment composition follows the same merge semantics as profile inheritance. See [Inheritance](./inheritance) for the per-section resolution rules.
...
- **[Exchange](/docs/specification/exchange)** — peer-to-peer (1:1) sharing of a fragment through a signed, consent-first offer flow ("AirDrop for harnesses"). See [HEP-7](https://github.com/harnessprotocol/harness-protocol/blob/main/heps/hep-0007-exchange-layer.md).
- **[Registry](/docs/specification/registry)** — hosted, one-to-many discovery: publish a fragment to a public index, then search and fetch it by purpose at `harnessprotocol.io`. See [HEP-8](https://github.com/harnessprotocol/harness-protocol/blob/main/heps/hep-0008-registry-layer.md).
