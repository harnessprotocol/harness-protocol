...
> Offer created: https://exchange.harnessprotocol.io/o/a3f1e2b4
> Expires: 2026-03-16 00:00 UTC

# Receiver — fetches by URL
harness exchange accept https://exchange.harnessprotocol.io/o/a3f1e2b4
```
...
1. **Relay server trust model**: If harnessprotocol.io operates the official relay, what are the availability, privacy, and governance commitments? What happens to offers when the relay is down? Should the spec define a relay API so community members can operate compatible relays?
