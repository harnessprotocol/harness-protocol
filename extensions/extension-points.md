...
- See https://harnessprotocol.io/extensions/hooks for the v2 design sketch.
```
...
This guarantee applies to the JSON Schema artifact at `schema/YYYY-MM-DD/`. Once published, a schema snapshot is permanent and immutable. The canonical URL `https://harnessprotocol.io/schema/v1/harness.schema.json` may be updated to point to newer snapshots, but all published snapshots remain accessible at their dated URLs.
