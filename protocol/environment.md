...
|-------|------|----------|---------|-------------|
| `name` | string | Yes | — | The environment variable name. Must match `^[A-Z_][A-Z0-9_]*$` — uppercase letters, digits, and underscores, starting with an uppercase letter or underscore. |
